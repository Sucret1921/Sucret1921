...
💻 Full Stack Dev — **web apps, APIs & automation tools**
🔐 Security enthusiast — Blue Team, OWASP, malware analysis & forensics
🛠️ I build tools that solve real problems and break systems (ethically)
🎯 CTF player · Web pentesting · Network & traffic analysis
📚 Constant learner — there's always a new vulnerability to study
🌍 Spain · Open to collaborations & open source projects
